    ...
    >
      <div className=" flex flex-col h-full items-start justify-between p-6 lg:px-20 lg:py-10">
        <div className="flexCenter gap-4">
          <div className="rounded-full bg-green-50 py-4">
        ...
        <div className="flexCenter gap-6">
          <span className="span flex overflow-hidden -space-x-4">
            {PEOPLE_URL.map((url) => (
              <Image
  ...
  return (
    <section className="relative flex flex-col py-10 2xl:max-container lg:mb-10 lg:py-20 xl:mb-20">
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
